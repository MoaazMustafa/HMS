      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-muted/50 border-muted rounded-lg border p-6 backdrop-blur-xl"
          >
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    className="bg-muted border-muted text-foreground focus:ring-primary/50 w-full rounded-lg border px-4 py-2 focus:ring-2 focus:outline-none"
                  />
                ) : (
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="bg-muted border-muted text-foreground focus:ring-primary/50 flex-1 rounded-lg border px-4 py-2 focus:ring-2 focus:outline-none"
              ...
              <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-foreground">
                      {userData.patient.address || 'Not provided'}
                    </p>
                  )}
                </div>
              </div>
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    <p className="text-muted-foreground">
                      ...
                      {userData.patient.emergencyContactRelation ||
                        'Not specified'}
                    </p>
                    <p className="text-muted-foreground">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <p className="text-muted-foreground mb-1 text-xs">Patient ID</p>
              ...
              <div>
                <p className="text-muted-foreground mb-1 text-xs">Gender</p>
                <p className="text-foreground text-sm">
