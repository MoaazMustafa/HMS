    ...
    <div className="container mx-auto p-6 max-w-5xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href={userRole === 'DOCTOR' ? '/dashboard/lab-orders' : '/dashboard/lab-results'}>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Test ID: {labTest.testId}</p>
          </div>
        </div>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-lg font-semibold text-foreground">{labTest.testName}</p>
          </div>
          {labTest.testType && (
            <div>
        ...
        {labTest.description && (
          <div className="mt-4">
            ...
            <p className="text-foreground leading-relaxed">{labTest.description}</p>
          </div>
        )}
      </Card>
        ...
        <Card className="p-4 bg-red-500/5 border-red-500/20">
          <div className="flex items-center gap-2 text-sm">
            ...
            <p className="text-muted-foreground">
              Critical values detected. An alert has been sent to the ordering physician.
            </p>
          </div>
        </Card>
      )}
        ...
        <Card className="p-4 bg-green-500/5 border-green-500/20">
          <div className="flex items-center gap-2 text-sm">
            ...
            <p className="text-muted-foreground">
              ...
              {labTest.doctor.lastName} on {format(new Date(labTest.reviewedAt), 'MMMM d, yyyy')}.
            </p>
          </div>
        </Card>
      )}
