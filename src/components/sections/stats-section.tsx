    ...
    <section id="stats" className="relative py-20 md:py-32">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div
          data-aos="zoom-in"
          data-aos-delay="300"
          className="border-border/50 from-primary/5 relative overflow-hidden rounded-3xl border bg-linear-to-br via-transparent to-transparent p-8 shadow-xl md:p-12"
        >
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-4">
            {[
              ...
              <div
                ...
                data-aos="flip-up"
                data-aos-delay={index * 100}
                className="border-border/50 bg-card/50 hover:border-primary/50 hover:shadow-primary/10 cursor-pointer rounded-2xl border p-6 text-center backdrop-blur-sm transition-all hover:shadow-lg"
              >
                <div className="text-muted-foreground mb-2 text-sm font-medium">
                  {item.label}
                </div>
                <div className="text-foreground mb-2 text-2xl font-bold lg:text-3xl">
                  {item.target}
                </div>
                <div
